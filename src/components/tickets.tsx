    ...
    <Card style={{ marginBottom: '0.5em' }}>
      <CardBody>
        ...
        {ticket.payment.accepted ? (
          <p>
            <FontAwesomeIcon icon={faCheckSquare} style={{ color: '#00DD00' }} /> 受付済み
          </p>
        ) : (
          <p>
            <FontAwesomeIcon icon={faExclamationCircle} style={{ color: 'orange' }} /> 未受付
          </p>
        )}
        <Row>
          {(() => {
            if (ticket.payment.error) {
              ...
              return (
                <>
                  ...
                  <Col xs="12">
                    <Link href={`/users/${user.uid}/payments/${ticket.payment.id}`}>
